...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String dbTuThu = "CREATE TABLE THUTHU(matt text primary key, hoten text,  matkhau text, loaitaikhoan text)";
        db.execSQL(dbTuThu);
        ...
        db.execSQL("INSERT INTO THUTHU VALUES('thuthu01', 'Nguyễn Văn Anh', '123456','Admin'), ('thuthu02','Nguyễn Văn Bá','123456','Thủ thư')");
